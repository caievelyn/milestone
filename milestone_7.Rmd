...
The below *Figure 5* demonstrates the marginal means graph 
...
mm_2 <- plot(DD_mm_diff) +
  labs(title = "Difference in Marginal Means by Gender",
                caption = "Data from Horiuchi, Smith, & Yamamato via Dataverse") +
  theme_minimal() +
  theme(legend.position = "none",
        axis.title.x = element_blank(),
...
*Figures 5 & 6*: The top graphic displays the marginal means graph. For comparison, the bottom graphic shows the difference in marginal means graph and the difference in AMCE graph. 
